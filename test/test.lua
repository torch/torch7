...
function torchtest.elementSize()
  ...
  local ushort = torch.UShortStorage():elementSize()
  local uint   =   torch.UIntStorage():elementSize()
  local ulong  =  torch.ULongStorage():elementSize()
  ...
  mytester:asserteq(ushort, torch.UShortTensor():elementSize())
  mytester:asserteq(uint,   torch.UIntTensor():elementSize())
  mytester:asserteq(ulong,  torch.ULongTensor():elementSize())
  ...
  mytester:assertne(ushort, 0)
  mytester:assertne(uint, 0)
  mytester:assertne(ulong, 0)
  ...
  mytester:assert(ushort >= 2)
  mytester:assert(uint >= 2)
  mytester:assert(uint >= ushort)
  mytester:assert(ulong >= 4)
  mytester:assert(ulong >= uint)
