...
- [Math Functions](#math-functions)
  - [Construction or extraction functions](#construction-or-extraction-functions)
    - [[res] torch.cat( [res,] x_1, x_2, [dimension] )](#res-torchcat-res-x_1-x_2-dimension-)
    - [[res] torch.diag([res,] x [,k])](#res-torchdiagres-x-k)
    - [[res] torch.eye([res,] n [,m])](#res-torcheyeres-n-m)
    - [[res] torch.histc([res,] x [,nbins, min_value, max_value])](#res-torchhistcres-x-nbins-min_value-max_value)
    - [[res] torch.linspace([res,] x1, x2, [,n])](#res-torchlinspaceres-x1-x2-n)
    - [[res] torch.logspace([res,] x1, x2, [,n])](#res-torchlogspaceres-x1-x2-n)
    - [[res] torch.multinomial([res,], p, n, [,replacement])](#res-torchmultinomialres-p-n-replacement)
    - [[res] torch.ones([res,] m [,n...])](#res-torchonesres-m-n)
    - [[res] torch.rand([res,] m [,n...])](#res-torchrandres-m-n)
    - [[res] torch.randn([res,] m [,n...])](#res-torchrandnres-m-n)
    - [[res] torch.range([res,] x, y [,step])](#res-torchrangeres-x-y-step)
    - [[res] torch.randperm([res,] n)](#res-torchrandpermres-n)
    - [[res] torch.reshape([res,] x, m [,n...])](#res-torchreshaperes-x-m-n)
    - [[res] torch.tril([res,] x [,k])](#res-torchtrilres-x-k)
    - [[res] torch.triu([res,] x, [,k])](#res-torchtriures-x-k)
    - [[res] torch.zeros([res,] x)](#res-torchzerosres-x)
  - [Element-wise Mathematical Operations](#element-wise-mathematical-operations)
    - [[res] torch.abs([res,] x)](#res-torchabsres-x)
    - [[res] torch.acos([res,] x)](#res-torchacosres-x)
    - [[res] torch.asin([res,] x)](#res-torchasinres-x)
    - [[res] torch.atan([res,] x)](#res-torchatanres-x)
    - [[res] torch.ceil([res,] x)](#res-torchceilres-x)
    - [[res] torch.cos([res,] x)](#res-torchcosres-x)
    - [[res] torch.cosh([res,] x)](#res-torchcoshres-x)
    - [[res] torch.exp([res,] x)](#res-torchexpres-x)
    - [[res] torch.floor([res,] x)](#res-torchfloorres-x)
    - [[res] torch.log([res,] x)](#res-torchlogres-x)
    - [[res] torch.log1p([res,] x)](#res-torchlog1pres-x)
    - [[res] torch.pow([res,] x, n)](#res-torchpowres-x-n)
    - [[res] torch.round([res,] x)](#res-torchroundres-x)
    - [[res] torch.sin([res,] x)](#res-torchsinres-x)
    - [[res] torch.sinh([res,] x)](#res-torchsinhres-x)
    - [[res] torch.sqrt([res,] x)](#res-torchsqrtres-x)
    - [[res] torch.tan([res,] x)](#res-torchtanres-x)
    - [[res] torch.tanh([res,] x)](#res-torchtanhres-x)
  - [Basic operations](#basic-operations)
    - [[res] torch.add([res,] tensor, value)](#res-torchaddres-tensor-value)
    - [[res] torch.add([res,] tensor1, tensor2)](#res-torchaddres-tensor1-tensor2)
    - [[res] torch.add([res,] tensor1, value, tensor2)](#res-torchaddres-tensor1-value-tensor2)
    - [[res] torch.mul([res,] tensor1, value)](#res-torchmulres-tensor1-value)
    - [[res] torch.clamp([res,] tensor1, min_value, max_value)](#res-torchclampres-tensor1-min_value-max_value)
    - [[res] torch.cmul([res,] tensor1, tensor2)](#res-torchcmulres-tensor1-tensor2)
    - [[res] torch.cpow([res,] tensor1, tensor2)](#res-torchcpowres-tensor1-tensor2)
    - [[res] torch.addcmul([res,] x [,value], tensor1, tensor2)](#res-torchaddcmulres-x-value-tensor1-tensor2)
    - [[res] torch.div([res,] tensor, value)](#res-torchdivres-tensor-value)
    - [[res] torch.cdiv([res,] tensor1, tensor2)](#res-torchcdivres-tensor1-tensor2)
    - [[res] torch.addcdiv([res,] x [,value], tensor1, tensor2)](#res-torchaddcdivres-x-value-tensor1-tensor2)
    - [[number] torch.dot(tensor1,tensor2)](#number-torchdottensor1tensor2)
    - [[res] torch.addmv([res,] [beta,] [v1,] vec1, [v2,] mat, vec2)](#res-torchaddmvres-beta-v1-vec1-v2-mat-vec2)
    - [[res] torch.addr([res,] [v1,] mat, [v2,] vec1, vec2)](#res-torchaddrres-v1-mat-v2-vec1-vec2)
    - [[res] torch.addmm([res,] [beta,] [v1,] M [v2,] mat1, mat2)](#res-torchaddmmres-beta-v1-m-v2-mat1-mat2)
    - [[res] torch.addbmm([res,] [v1,] M [v2,] batch1, batch2)](#res-torchaddbmmres-v1-m-v2-batch1-batch2)
    - [[res] torch.baddbmm([res,] [v1,] M [v2,] batch1, batch2)](#res-torchbaddbmmres-v1-m-v2-batch1-batch2)
    - [[res] torch.mv([res,] mat, vec)](#res-torchmvres-mat-vec)
    - [[res] torch.mm([res,] mat1, mat2)](#res-torchmmres-mat1-mat2)
    - [[res] torch.bmm([res,] batch1, batch2)](#res-torchbmmres-batch1-batch2)
    - [[res] torch.ger([res,] vec1, vec2)](#res-torchgerres-vec1-vec2)
  - [Overloaded operators](#overloaded-operators)
    - [Addition and subtraction](#addition-and-subtraction)
    - [Negation](#negation)
    - [Multiplication](#multiplication)
    - [Division](#division)
  - [Column or row-wise operations  (dimension-wise operations)](#column-or-row-wise-operations--dimension-wise-operations)
    - [[res] torch.cross([res,] a, b [,n])](#res-torchcrossres-a-b-n)
    - [[res] torch.cumprod([res,] x [,dim])](#res-torchcumprodres-x-dim)
    - [[res] torch.cumsum([res,] x [,dim])](#res-torchcumsumres-x-dim)
    - [torch.max([resval, resind,] x [,dim])](#torchmaxresval-resind-x-dim)
    - [[res] torch.mean([res,] x [,dim])](#res-torchmeanres-x-dim)
    - [torch.min([resval, resind,] x [,dim])](#torchminresval-resind-x-dim)
    - [[res] torch.cmax([res,] tensor1, tensor2)](#res-torchcmaxres-tensor1-tensor2)
    - [[res] torch.cmax([res,] tensor, value)](#res-torchcmaxres-tensor-value)
    - [[res] torch.cmin([res,] tensor1, tensor2)](#res-torchcminres-tensor1-tensor2)
    - [[res] torch.cmin([res,] tensor, value)](#res-torchcminres-tensor-value)
    - [torch.median([resval, resind,] x [,dim])](#torchmedianresval-resind-x-dim)
    - [torch.kthvalue([resval, resind,] x, k [,dim])](#torchkthvalueresval-resind-x-k-dim)
    - [[res] torch.prod([res,] x [,n])](#res-torchprodres-x-n)
    - [torch.sort([resval, resind,] x [,d] [,flag])](#torchsortresval-resind-x-d-flag)
    - [[res] torch.std([res,] x, [,dim] [,flag])](#res-torchstdres-x-dim-flag)
    - [[res] torch.sum([res,] x)](#res-torchsumres-x)
    - [[res] torch.var([res,] x [,dim] [,flag])](#res-torchvarres-x-dim-flag)
  - [Matrix-wide operations  (tensor-wide operations)](#matrix-wide-operations--tensor-wide-operations)
    - [torch.norm(x [,p] [,dim])](#torchnormx-p-dim)
    - [torch.renorm([res], x, p, dim, maxnorm)](#torchrenormres-x-p-dim-maxnorm)
    - [torch.dist(x,y)](#torchdistxy)
    - [torch.numel(x)](#torchnumelx)
    - [torch.trace(x)](#torchtracex)
  - [Convolution Operations](#convolution-operations)
    - [[res] torch.conv2([res,] x, k, [, 'F' or 'V'])](#res-torchconv2res-x-k--f-or-v)
    - [[res] torch.xcorr2([res,] x, k, [, 'F' or 'V'])](#res-torchxcorr2res-x-k--f-or-v)
    - [[res] torch.conv3([res,] x, k, [, 'F' or 'V'])](#res-torchconv3res-x-k--f-or-v)
    - [[res] torch.xcorr3([res,] x, k, [, 'F' or 'V'])](#res-torchxcorr3res-x-k--f-or-v)
  - [Eigenvalues, SVD, Linear System Solution](#eigenvalues-svd-linear-system-solution)
    - [[x,lu] torch.gesv([resb, resa,] b, a)](#xlu-torchgesvresb-resa-b-a)
    - [[x] torch.trtrs([resb, resa,] b, a [, 'U' or 'L'] [, 'N' or 'T'] [, 'N' or 'U'])](#x-torchtrtrsresb-resa-b-a--u-or-l--n-or-t--n-or-u)
    - [torch.gels([resb, resa,] b, a)](#torchgelsresb-resa-b-a)
    - [torch.symeig([rese, resv,] a [, 'N' or 'V'] [, 'U' or 'L'])](#torchsymeigrese-resv-a--n-or-v--u-or-l)
    - [torch.eig([rese, resv,] a [, 'N' or 'V'])](#torcheigrese-resv-a--n-or-v)
    - [torch.svd([resu, ress, resv,] a [, 'S' or 'A'])](#torchsvdresu-ress-resv-a--s-or-a)
    - [torch.inverse([res,] x)](#torchinverseres-x)
    - [torch.qr([q, r], x)](#torchqrq-r-x)
    - [torch.geqrf([m, tau], a)](#torchgeqrfm-tau-a)
    - [torch.orgqr([q], m, tau)](#torchorgqrq-m-tau)
  - [Logical Operations on Tensors](#logical-operations-on-tensors)
    - [torch.lt(a, b)](#torchlta-b)
    - [torch.le(a, b)](#torchlea-b)
    - [torch.gt(a, b)](#torchgta-b)
    - [torch.ge(a, b)](#torchgea-b)
    - [torch.eq(a, b)](#torcheqa-b)
    - [torch.ne(a, b)](#torchnea-b)
    - [torch.all(a)](#torchalla)
    - [torch.any(a)](#torchanya)
...
`e,V=torch.symeig(A)` returns eigenvalues and eigenvectors of a
...
`e,V=torch.eig(A)` returns eigenvalues and eigenvectors of a
...
Note: Irrespective of the original strides, the returned matrix `y` will be
transposed, i.e. with strides `1,m` instead of `m,1`.
